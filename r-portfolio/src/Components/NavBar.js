...
const NavBar = () => {
  ...
  return (
    <div className="w-full p-[10px] flex justify-between items-cente border-b-2 border-white">
     <p className="font-size: 8rem;
line-height: 1 font-weight: 900">K/A</p>
      <div>
        <ul className="hidden md:flex">
          <li className="menuItem hover:scale-110 hover:z-50 transition-all duration-300 ease-in-out">
            <a href="/#home">Home</a>
          </li>
          <li className="menuItem hover:scale-110 ml-4">
